...
use actix_jwt_api::{database::db::run_pending_migrations_db, http::{controllers::{auth_controller, email_controller, product_controller, user_controller}, middleware::brute_force_wall_middleware::brute_force_wall_middleware}, services::google_oauth2};
...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(|| {
        let app = App::new()
            ...
            .configure(google_oauth2::config)
